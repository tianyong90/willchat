...
var _vueAxios = __webpack_require__(74);
...
router.beforeEach(function (to, from, next) {
  ...
  _index2.default.commit('UPDATE_TOPMENU_VISIBLE', to.matched.some(function (record) {
    return record.meta.topmenuVisible;
  }));
  _index2.default.commit('UPDATE_SIDEBAR_VISIBLE', to.matched.some(function (record) {
    return record.meta.sidebarVisible;
  }));
...
var app = new _vue2.default({
  ...
  components: {
    'topmenu': __webpack_require__(194),
    'sidebar': __webpack_require__(199)
  },
  ...
  computed: (0, _extends3.default)({}, (0, _vuex.mapState)({
    ...
    topmenuVisible: function topmenuVisible(state) {
      return state.topmenuVisible;
    },
    sidebarVisible: function sidebarVisible(state) {
      return state.sidebarVisible;
    }
  }), (0, _vuex.mapGetters)(['accounts', 'user'])),
...
module.exports = "/js/fonts/vendor/element-ui/lib/theme-default/element-icons.woff?d2f69a92faa6fe990d2e613c358be705";

/***/ }),
/* 164 */
/***/ (function(module, exports) {

module.exports = "/js/fonts/vendor/element-ui/lib/theme-default/element-icons.ttf?b02bdc1b846fd65473922f5f62832108";
...
var _mutations = __webpack_require__(188);
...
var mutations = {
  ...
  UPDATE_TOPMENU_VISIBLE: function UPDATE_TOPMENU_VISIBLE(state, value) {
    state.topmenuVisible = value;
  },
  UPDATE_SIDEBAR_VISIBLE: function UPDATE_SIDEBAR_VISIBLE(state, value) {
    state.sidebarVisible = value;
  },
  UPDATE_ACCOUNTS: function UPDATE_ACCOUNTS(state, value) {
...
var actions = {
  storeUserToLocal: function storeUserToLocal(_ref, user) {
    ...
    localStorage.setItem(_config2.default.userKey, (0, _stringify2.default)(user));
  }
};
...
var getters = {
  accounts: function accounts(state) {
    var temp = window.localStorage.getItem(_config2.default.accountsKey);

    return temp ? JSON.parse(temp) : [];
  },

  user: function user(state) {
    var temp = window.localStorage.getItem(_config2.default.userKey);
...
var routes = [{
  ...
  component: function component(resolve) {
    __webpack_require__.e/* require.ensure */(0).then((function () {
      return resolve(__webpack_require__(77));
    }).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
  },
  meta: {
    topmenuVisible: true,
  ...
  component: function component(resolve) {
    __webpack_require__.e/* require.ensure */(14).then((function () {
      return resolve(__webpack_require__(221));
    }).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
  },
  meta: {
    title: '404',
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-73f55204", Component.options)
  } else {
    hotAPI.reload("data-v-73f55204", Component.options)
  }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(41)("12b6d9ac", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-73f55204\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../node_modules/sass-loader/lib/loader.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./topmenu.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-73f55204\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../node_modules/sass-loader/lib/loader.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./topmenu.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.logo[data-v-73f55204] {\n  display: block;\n  overflow: hidden;\n  float: left;\n  width: 115px;\n  color: white;\n  font-size: 1.2rem;\n  font-weight: bold;\n  margin: 20px;\n}\n#right-part .avatar[data-v-73f55204] {\n  display: block;\n  float: right;\n  width: 40px;\n  height: 40px;\n  background: red;\n  border-radius: 50%;\n  margin: 10px 10px 0 20px;\n  outline: none;\n}\n#right-part #dropdown-menu[data-v-73f55204] {\n  float: right;\n  color: white;\n  font-size: 1.1rem;\n  margin-top: 20px;\n}\n", ""]);
...
exports.default = {
  computed: (0, _extends3.default)({}, (0, _vuex.mapGetters)(['accounts', 'user'])),
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('el-menu', {
    ...
    staticClass: "logo"
  }, [_vm._v("WILLCHAT")]), _vm._v(" "), _c('el-menu-item', {
    attrs: {
      "index": "/"
    }
    ...
    slot: "title"
  }, [_vm._v("公众号切换")]), _vm._v(" "), _vm._l((_vm.accounts), function(account) {
    return _c('el-menu-item', {
      ...
      on: {
        "click": function($event) {
          _vm.changeAccount(account.id)
        }
      }
    }, [_vm._v(_vm._s(account.name) + "\n    ")])
  })], 2), _vm._v(" "), _c('el-menu-item', {
    attrs: {
      "index": "/document/lists"
    }
  }, [_vm._v("帮助中心")]), _vm._v(" "), _c('div', {
    attrs: {
      "id": "right-part"
    }
  }, [_c('router-link', {
    ...
    staticClass: "el-dropdown-link nickname",
    domProps: {
  ...
  }, [_vm._v("用户信息")]), _vm._v(" "), _c('el-dropdown-item', {
    nativeOn: {
      "click": function($event) {
        _vm.logout($event)
      }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-73f55204", module.exports)
  }
}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3e0d652c", Component.options)
  } else {
    hotAPI.reload("data-v-3e0d652c", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(41)("45d7feee", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-3e0d652c\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../node_modules/sass-loader/lib/loader.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./sidebar.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-3e0d652c\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../node_modules/sass-loader/lib/loader.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./sidebar.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
exports.default = {
  ...
  methods: {
    selected: function selected(index, indexPath) {
      console.log(index);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, _vm._l((_vm.MenuConfig), function(item, index) {
    ...
    }), _vm._v(_vm._s(item.title))]), _vm._v(" "), _vm._l((item.subItems), function(subItem) {
      return _c('el-menu-item', {
        key: subItem.index,
        attrs: {
          "index": subItem.route
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-3e0d652c", module.exports)
  }
}
