        ...
        <div class="content">
            ...
            <form class="login-form" action="{:U('User/Public/login')}" method="post">
                ...
                <div class="create-account">
                    <p>
                    <a href="{{ url('auth/register') }}" id="register-btn" class="uppercase">新用户注册</a>
                    </p>
                </div>
            </form>
            <!-- END LOGIN FORM -->
            ...
            <form class="register-form" action="{:U('User/Public/register')}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="确认密码" name="repassword"/>
                </div>
                <div class="form-group">
