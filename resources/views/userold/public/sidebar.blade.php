  ...
  <div class="page-sidebar navbar-collapse collapse">
    ...
    <ul class="page-sidebar-menu" id="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true"
      ...
      <li>
        ...
        <ul class="sub-menu">
          <li><a href="{{ user_url('system-function/') }}">功能管理</a></li>
          <li><a href="{{ user_url('merchant/') }}">商家信息</a></li>
          <li><a href="{{ user_url('payment/') }}">支付设置</a></li>
      ...
      <li>
        ...
        <ul class="sub-menu">
          <li><a href="{{ user_url('qrcode/') }}">二维码</a></li>
        </ul>
      </li>
      <li>
        <a href="javascript:;">
