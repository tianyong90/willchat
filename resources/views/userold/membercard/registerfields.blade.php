            ...
            <notempty name="list">
              <foreach name="list" item="item" key="k">
                <tr>
                  <td>{$item.title}</td>
                  <td>
                    <input class="form-control" type="checkbox" name="field_list[]" value="{$k}"
                    <in name="k" value="$info['field_list']">checked</in>
                    >
                  </td>
                  <td>
                    <input class="form-control" type="checkbox" name="required_list[]" value="{$k}"
                    <in name="k" value="$info['required_list']">checked</in>
                    >
                  </td>
                </tr>
              </foreach>
