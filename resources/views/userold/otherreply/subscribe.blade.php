    ...
    <div class="portlet-body form">
      <form class="form-horizontal validate" role="form" method="post" action="__SELF__">
        <div class="row">
              ...
              <div class="col-md-9">
                <div class="radio-list">
                  ...
                  <label class="radio-inline">
                    ...
                    <eq name="info.is_news" value="1">checked</eq>
                    > 图文回复 </label>
                </div>
              </div>
            </div>
            <div id="content" class="form-group <notempty name=" info.is_news
            ">display-hide</notempty>">
          ...
          <div id="keyword" class="form-group <empty name=" info.is_news
          ">display-hide</empty>">
          ...
          <div class="col-md-9">
            <select name="keyword" class="form-control input-small select2me" data-placeholder="选择关键词">
              <foreach name="keyword_list" item="item">
                <option value="{$item}"
                <eq name="info.keyword" value="$item">selected</eq>
                >{$item}</option>
              </foreach>
            </select>
