            ...
            <div class="tab-pane active" id="tab1">
              ...
              <table>
                  ...
                  <td>
                    ...
                    <select name="category_id" id="category_id" class="form-control input-small">
                      ...
                      <volist name="categorylist" id="cate">
                        ...
                        <eq name="info.category_id" value="$cate['id']">selected</eq>
                        >{$cate.name}</option>
                      </volist>
                    </select>
                  </td>
                ...
                <tr>
                  <td>
                    <label>关键词</label>
                    <input type="text" name="keyword" value="{$info.keyword}" class="form-control input-small"
                           placeholder="">
                  </td>
                  <td>
                    <label>排序</label>
            ...
            <div class="tab-pane" id="tab3">
              <table>
                <tr>
                  <td>
                    <label>邮费</label>
                    <input type="text" name="freight" value="{$info.freight}" class="form-control input-small"
                           placeholder="">
                  </td>
                  <td>
                    <label>库存</label>
                    <input type="text" name="stock" value="{$info.stock}" class="form-control input-small"
                           placeholder="">
                  </td>
                  <td>
                    <label>支持邮费到付</label>
                    <input type="checkbox" name="freight_buyerpay" value="1" class="form-control input-small block"
                    <notempty name="info.freight_buyerpay">checked</notempty>
                    >
                  </td>
                </tr>
                <tr>
                  <td>
                    <label>展示价格</label>
                    <input type="text" name="price_display" value="{$info.price_display}"
                           class="form-control input-small" placeholder="">
                  </td>
                  <td>
                    <label>原价</label>
                    <input type="text" name="original_price" value="{$info.original_price}"
                           class="form-control input-small" placeholder="">
                  </td>
                  <td>
                    <label>价格区间</label>
                    ...
                    <div>
                      <input type="text" name="price_range_min" value="{$info.price_range_min}"
                             class="form-control input-small fl" placeholder="">
                      <span class="fl">到</span>
                      <input type="text" name="price_range_max" value="{$info.price_range_max}"
                             class="form-control input-small fl" placeholder="">
                    </div>
                  </td>
                </tr>
