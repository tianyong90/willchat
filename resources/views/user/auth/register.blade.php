...
<html lang="zh-CN">
    ...
    <head>
        ...
        <link href="{{ vendor('metronic/admin/pages/css/login.css') }}" rel="stylesheet" type="text/css"/>
        ...
        <link href="{{ vendor('metronic/admin/layout/css/themes/darkblue.css') }}" rel="stylesheet" type="text/css" id="style_color"/>
