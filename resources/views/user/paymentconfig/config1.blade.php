    ...
    <form action="__SELF__" method="post">
      <div class="form-body">
        <div class="form-group">
          <label>商户号</label>
          <input type="text" name="config_param[mchid]" value="{$info['config_param']['mchid']}" class="form-control"
                 placeholder="请填写微信支付商户号">
          <span class="help-block"></span>
        </div>
        <div class="form-group">
          <label>支付密钥</label>
          <input type="text" name="config_param[mchkey]" value="{$info['config_param']['mchkey']}" class="form-control"
                 placeholder="请填写支付密钥">
        ...
        <div class="form-group">
          ...
          <div class="input-group">
            <input type="text" name="config_param[apiclient_cert]" value="{$info['config_param']['apiclient_cert']}"
                   class="form-control" placeholder="请上传微信支付商户证书" readonly>
        ...
        <div class="form-group">
          ...
          <div class="input-group">
            <input type="text" name="config_param[apiclient_key]" value="{$info['config_param']['apiclient_key']}"
                   class="form-control" placeholder="请上传微信支付密钥证书" readonly>
                        <span class="input-group-btn">
