            ...
            <form class="form-horizontal" role="form" method="post" action="__SELF__">
                <div class="form-body">
                        ...
                        <div class="col-md-9">
                            <div class="pic-control">
                                <span class="thumbnail">
                                    <img src="{$card['base_info']['logo_url']|default='./Public/User/images/no_picture.gif'}" alt="点击预览">
                                </span>
                                <div class="buttons">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <select name="color" id="colorlsit" class="form-control input-small" style="background:{$card['base_info']['color']}">
                                <foreach name="colors" item="color">
                                    <option class="color" style="background:{$color['value']}" value="{$color.name}" <eq name="card['base_info']['color']" value="$color['value']">selected</eq>>{$color.name}</option>
                                </foreach>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <select class="form-control input-small" id="code_type" name="code_type">
                                <option value="CODE_TYPE_TEXT" <eq name="card['base_info']['code_type']" value="CODE_TYPE_TEXT">selected</eq>>文本</option>
                                <option value="CODE_TYPE_BARCODE" <eq name="card['base_info']['code_type']" value="CODE_TYPE_BARCODE">selected</eq>>条码和文本</option>
                                <option value="CODE_TYPE_QRCODE" <eq name="card['base_info']['code_type']" value="CODE_TYPE_QRCODE">selected</eq>>二维码和文本</option>
                                <option value="CODE_TYPE_ONLY_QRCODE" <eq name="card['base_info']['code_type']" value="CODE_TYPE_ONLY_QRCODE">selected</eq>>仅二维码</option>
                                <option value="CODE_TYPE_ONLY_BARCODE" <eq name="card['base_info']['code_type']" value="CODE_TYPE_ONLY_BARCODE">selected</eq>>仅条码</option>
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="notice" id="notice" class="form-control input-medium" value="{$card['base_info']['notice']}"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="get_limit" id="get_limit" class="form-control input-small" value="{$card['base_info']['get_limit']}"/>
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="use_limit" id="use_limit" class="form-control input-small" value="{$card['base_info']['use_limit']}"/>
                            <span class="help-block"></span>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <div class="checkbox-list">
                                ...
                                <input name="can_share" type="checkbox" value="1" <eq name="card['base_info']['can_share']" value="true">checked</eq>> 可分享 </label>
                                <label class="checkbox-inline">
                                <input name="can_give_friend" type="checkbox" value="1" <eq name="card['base_info']['can_give_friend']" value="true">checked</eq>> 可转赠 </label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="custom_url_name" id="custom_url_name" class="form-control input-medium" value="{$card['base_info']['custom_url_name']}"/>
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="custom_url" id="custom_url" class="form-control input-medium" value="{$card['base_info']['custom_url']}"/>
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="custom_url_sub_title" id="custom_url_sub_title" class="form-control input-medium" value="{$card['base_info']['custom_url_sub_title']}"/>
                    ...
                    <switch name="type">
                        ...
                        <case value="member_card">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <textarea name="bonus_cleared" class="form-control" cols="30" rows="3">{$card['bonus_cleared']}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <textarea name="bonus_rules" class="form-control" cols="30" rows="3">{$card['bonus_rules']}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <textarea name="balance_rules" class="form-control" cols="30" rows="3">{$card['balance_rules']}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <textarea name="prerogative" class="form-control" cols="30" rows="3">{$card['prerogative']}</textarea>
...
@stop
@section('script')
<script type="text/javascript" src="{{ asset('static') }}/metronic/assets/global/plugins/bootstrap-daterangepicker/moment.min.js"></script>
<script type="text/javascript" src="{{ asset('static') }}/metronic/assets/global/plugins/bootstrap-daterangepicker/daterangepicker.js"></script>
<script>
    $(function () {
        //切换颜色选项
