...
@section('js')
  <script type="text/javascript"
          src="{{ vendor('metronic/global/plugins/bootstrap-daterangepicker/moment.min.js') }}"></script>
  <script type="text/javascript"
          src="{{ vendor('metronic/global/plugins/bootstrap-daterangepicker/daterangepicker.js') }}"></script>
  <script>
    $(function () {
      //切换颜色选项
