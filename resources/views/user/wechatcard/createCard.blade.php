...
@section('style')
  ...
  <link rel="stylesheet" type="text/css"
        href="{{ asset('static') }}/metronic/global/plugins/bootstrap-daterangepicker/daterangepicker-bs3.css"/>
@stop
@section('main')
        ...
        <form class="form-horizontal" role="form" method="post" action="">
          <div class="form-body">
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input name="brand_name" type="text" id="brand_name" class="form-control input-large"
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input name="service_phone" type="text" id="service_phone" class="form-control input-large"
                       value="{$card.service_phone}">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input name="sub_title" type="text" id="sub_title" class="form-control input-large"
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input type="text" name="quantity" id="quantity" class="form-control input-small"
                       value="{$card.quantity}"/>
                <span class="help-block"></span>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input type="text" name="custom_url_name" id="custom_url_name" class="form-control input-large"
                       value="{$card.custom_url_name}"/>
                <span class="help-block"></span>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input type="text" name="custom_url" id="custom_url" class="form-control input-large"
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input type="text" name="custom_url_sub_title" id="custom_url_sub_title"
                       class="form-control input-large" value="{$card.custom_url_sub_title}"/>
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input type="text" name="promotion_url_name" id="promotion_url_name" class="form-control input-large"
                       value="{$card.promotion_url_name}"/>
                <span class="help-block"></span>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input type="text" name="promotion_url" id="promotion_url" class="form-control input-large"
                       value="{$card.promotion_url}"/>
                <span class="help-block"></span>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input type="text" name="promotion_url_sub_title" id="promotion_url_sub_title"
                       class="form-control input-large" value="{$card.promotion_url_sub_title}"/>
                <span class="help-block">6个汉字以内</span>
              </div>
            </div>
...
@section('script')
  ...
  <script type="text/javascript"
          src="{{ asset('static') }}/metronic/global/plugins/bootstrap-daterangepicker/daterangepicker.js"></script>
  <script>
    $(function () {
      //切换颜色选项
