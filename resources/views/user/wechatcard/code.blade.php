                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn">
                                            <button class="btn btn-success" type="submit"><i class="fa fa-arrow-left fa-fw"></i> 核销CODE </button>
                                        </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn">
                                            <button class="btn btn-success" type="submit"><i class="fa fa-arrow-left fa-fw"></i> 设置CODE失效 </button>
                                        </span>
                                    </div>
                                </div>
                            </div>
