                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $group['count'] }}</td>
                            <td>
                                <a class="btn blue btn-xs dialog-popup" href="{{ user_url('fans-group/edit/'.$group['id']) }}">编辑</a>
                                <button class="btn red btn-xs btn-delete-confirm" data-link="{{ user_url('fans-group/delete/'.$group['id']) }}">删除</button>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
