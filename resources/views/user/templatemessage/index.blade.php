...
<div class="portlet light">
    <div class="portlet-title">
        ...
        <div class="actions">
            ...
            <a href="{:U('add',array('token'=>$token))}" class="btn default blue-stripe btn-xs dialog-popup"><i class="fa fa-plus"></i>&nbsp;添加消息模板</a>
        </div>
    </div>
                    ...
                    <notempty name="msg_tmpls">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn red btn-xs btn-delete-confirm" data-link="{:U('deleteTmpl',array('id'=>$vo['id']))}">删除</button>
                            </td>
                        </tr>
                        </volist>
                    <else/>
