                            ...
                            <div class="tab-content">
                                        ...
                                        * </span>
                                        ...
                                        <div class="col-md-4">
                                            <select id="type" name="type" class="form-control">
                                                <option value="1" <eq name="info.type" value="1">selected</eq>
                                                >订阅号</option>
                                                <option value="2" <eq name="info.type" value="2">selected</eq>
                                                >认证订阅号</option>
                                                <option value="3" <eq name="info.type" value="3">selected</eq>
                                                >服务号</option>
                                                <option value="4" <eq name="info.type" value="4">selected</eq>
                                                >认证服务号</option>
                                            </select>
                                ...
                                <div class="tab-pane" id="tab3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        * </span>
                                        ...
                                        <div class="col-md-4">
                                            <select id="luckversion" name="luckversion" class="form-control" value="{$info.luckversion}" onchange="versionchange(this)" disabled readonly>
                                                <option value="NAKE_JD" <eq name="info.luckversion" value="NAKE_JD">selected</eq>
                                                >经典版</option>
                                                <option value="NAKE_SM" <eq name="info.luckversion" value="NAKE_SM">selected</eq>
                                                >商盟基础版</option>
                                                <option value="NAKE_SM_ULTIMATE" <eq name="info.luckversion" value="NAKE_SM_ULTIMATE">selected</eq>
                                                >商盟旗舰版</option>
                                                <option value="NAKE_QY" <eq name="info.luckversion" value="NAKE_QY">selected</eq>
                                                >企业版</option>
                                            </select>
                                ...
                                <div class="tab-pane" id="tab4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <p class="form-control-static wx-url-display">http://{$Think.server.HTTP_HOST}/index.php/token/{$info.token}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="form-group">
...
<script type="text/javascript" src="{{ asset('static') }}/metronic/global/plugins/jquery-validation/js/jquery.validate.min.js"></script>
<script type="text/javascript" src="{{ asset('static') }}/metronic/global/plugins/jquery-validation/js/additional-methods.min.js"></script>
