...
@section('style')
    ...
    <link rel="stylesheet" href="{{ asset('static') }}/metronic/global/plugins/bootstrap-colorpicker/css/colorpicker.css"/>
@stop
@section('main')
                ...
                <form class="form-horizontal validate" role="form" method="post" action="__SELF__">
                    <div class="form-body">
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select name="bg" id="select-bg" class="form-control input-small">
                                            <for start="1" end="26">
                                            <option value="{$i}" <eq name="cardinfo.bg" value="$i">selected</eq>>{$i}</option>}
                                            </for>
                                        </select>
                                    ...
                                    <div class="col-md-9">
                                        <div class="checkbox-list">
                                            <label class="checkbox-inline">
                                                <input type="checkbox" name="display_cardname" value="1" <notempty name="cardinfo.display_cardname">checked</notempty>> 会员卡名
                                            </label>
                                            <label class="checkbox-inline">
                                                <input type="checkbox" name="display_cardnumber" value="1" <notempty name="cardinfo.display_cardnumber">checked</notempty>> 会员卡号
                                            </label>
                                            <label class="checkbox-inline">
                                                <input type="checkbox" name="display_cardlogo" value="1" <notempty name="cardinfo.display_cardlogo">checked</notempty>> 会员卡图标
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <!-- 会员卡预览 -->
                                <div id="cardpreview" style="background-image:url(__ROOT__/Public/Wap/images/MemberCard/card_bg/card_bg{$cardinfo.bg|default=1}.png);">
...
@stop
@section('script')
    <script src="{{ asset('static') }}/metronic/global/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.js"></script>
