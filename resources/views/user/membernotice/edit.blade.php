...
@section('style')
    <link rel="stylesheet" type="text/css" href="{{ asset('static') }}/metronic/global/plugins/bootstrap-datepicker/css/datepicker3.css"/>
@stop
<block name="content">
    <!-- BEGIN PAGE CONTENT-->
...
@stop
@section('script')
    <script type="text/javascript" src="{{ asset('static') }}/metronic/global/plugins/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
    <script>
        $(function(){
