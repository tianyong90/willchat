            ...
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <select name="cate_id" id="" class="form-control">
                        ...
                        <volist name="catetree" id="treeitem">
                            <option value="{$treeitem.id}" <eq name="info.cate_id" value="$treeitem.id">selected</eq>>{$treeitem.name}</option>
                            <notempty name="treeitem._child">
                                <volist name="treeitem._child" id="child">
                                    <option value="{$child.id}" <eq name="info.cate_id" value="$child.id">selected</eq>>&nbsp;┕──{$child.name}</option>
                                </volist>
                            </notempty>
                        </volist>                                        
                    </select>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-btn"><a class="btn green"  data-toggle="modal" data-target="#linkselect" href="{:U('User/Link/insert',array('targetid'=>'url'))}"><i class="fa fa-link"></i></a></span>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="radio-list">
                        ...
                        <label class="radio-inline">
                            <input type="radio" name="status" value="0" <eq name="info.status" value="0">checked</eq>> 禁用 </label>
                    </div>
                </div>
            </div>
