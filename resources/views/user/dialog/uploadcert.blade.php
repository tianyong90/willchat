...
<!-- Generic page styles -->
<link href="{{ asset('static') }}/metronic/global/plugins/jquery-file-upload/blueimp-gallery/blueimp-gallery.min.css" rel="stylesheet"/>
<link href="{{ asset('static') }}/metronic/global/plugins/jquery-file-upload/css/jquery.fileupload.css" rel="stylesheet"/>
<link href="{{ asset('static') }}/metronic/global/plugins/jquery-file-upload/css/jquery.fileupload-ui.css" rel="stylesheet"/>
</head>
...
<div class="container">
    ...
    <span class="btn btn-success fileinput-button">
        ...
        <input id="fileupload" type="file" name="files" accept="pem">
    </span>
    <br>
    <br>
...
<script src="{{ asset('static') }}/metronic/global/plugins/jquery-file-upload/js/jquery.fileupload-validate.js"></script>
...
$(function () {
    ...
    var url = Think.U('User/File/uploadCert','type='+type+'&token='+'{$Think.get.token}');
    ...
    $('#fileupload').fileupload({
        ...
        if (data.result.status) {
            var link = $('<a>')
                .attr('target', '_blank')
                .prop('href', data.result.files.path);
            $(data.context.children()[0])
                .wrap(link);

            //上传文件保存到对话框data中以便调用
            currentDialog.data.filepath=data.result.files.path;
        } else{
